...
def get_args():
	...
	parser.add_argument('--quota', '-q', default=10000, type=int, help='quota of active learning')
	...
	parser.add_argument('--initseed', '-s', default = 2500, type = int, help = 'Initial pool of labeled data')
